...
and runs the installed `aiba` binary. It verifies `--version`, `init`, verified
catalog discovery, Solution details, `inspect`, and `add identity`; the final
commands prove that packaged official capabilities and Solutions resolve
independently of the repository checkout.
...
Last verified on 2026-08-04 with Node.js 24.14.0 and npm 11.9.0: four artifacts

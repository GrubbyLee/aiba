...
| --- | --- | --- |
| Application foundation | Cross-project application boundaries | `identity`, `authorization`, `users`, `notification`, `verification-challenge`, `file-assets`, `scheduled-jobs`, `feature-flags`, `organization`, `search`, `review-access` |
